...
public class KThread {
    ...
    public static void finish() {
        ...
        if (currentThread.waitedThread != null) {
            currentThread.waitedThread.ready();
            currentThread.waitedThread = null;
        }
    ...
    public void join() {
        ...
        if (this.status != statusFinished) {
            boolean intstatus = Machine.interrupt().disable();
            this.waitedThread = currentThread;
            currentThread.sleep();
            Machine.interrupt().restore(intstatus);
        }
        this.lock.release();
    ...
    private KThread waitedThread = null;
}
